        ...
        <a-row :gutter="[40,0]">
            <a-col :span="18">
                <a-form-model ref="createForm" :model="createForm" :rules="createForm.rules">
                    ...
                    <a-form-model-item v-if="createForm.downMode == 1 && createForm.hasDown == 2" class="price" ref="price" prop="price">
                        <a-input-number
                        size="large" 
                    ...
                    <a-form-model-item v-if="createForm.hasDown == 2" ref="attribute" prop="attribute">
                        <a-row v-for="(item,index) in createForm.attribute" :key="index" :gutter="[40,0]" class="create-purpose">
                            <a-col :span="10">
                                <a-input v-model="item.key" :maxLength="40" size="large"  placeholder="请输入属性标题" />
                            </a-col>
                            <a-col :span="10">
                    ...
                    <a-form-model-item ref="content" prop="content">
                        <div class="video-box">
                            ...
                            <a-button v-if="createForm.link == null" type="primary" @click="uploadAudio" >上传音频</a-button>
