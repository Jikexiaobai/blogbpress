...
type sysReportColumns struct {
    ...
    RelatedId    string //                                                      
    Module       string //                                                      
    Type         string // 举报类型 1广告垃圾，2违规内容，3恶意灌水，4重复发帖  
    Description  string // 描述                                                 
    Remark       string //                                                      
    Status       string // 状态，2 已处理，1 未处理                             
    CreateTime   string //                                                      
    UpdateTime   string //
}
...
// see M.Where.
func (d *SysReportDao) All(where ...interface{}) ([]*model.SysReport, error) {
	all, err := d.M.All(where...)
	if err != nil {
		return nil, err
	}
	var entities []*model.SysReport
...
// The optional parameter <where> is the same as the parameter of M.Where function,
// see M.Where.
func (d *SysReportDao) One(where ...interface{}) (*model.SysReport, error) {
...
func (d *SysReportDao) FindOne(where ...interface{}) (*model.SysReport, error) {
...
func (d *SysReportDao) FindAll(where ...interface{}) ([]*model.SysReport, error) {
...
func (d *SysReportDao) Chunk(limit int, callback func(entities []*model.SysReport, err error) bool) {
